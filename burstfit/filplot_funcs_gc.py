...
# def proc_cand_fil_DM_time(fnfil, dm, ibox, snrheim=-1, 
#                   pre_rebin=1, nfreq_plot=64,
#                   heim_raw_tres=1, 
#                   rficlean=False, ndm=64, norm=True):
#     """ 
#     Dedisperse at many DM trails 
...
#     Returns:
#     ----------
#     data: de-dispersed time-frequncy data
#     datadm: time-DM data
#     tsdm0: dispersed time series (dm=0) 
#     dms: DM trails included in the time-DM data
#     datadm0: dispersed time-frequncy data (dm=0)

#     """
#     header = read_fil_data_dsa(fnfil, 0, 1)[-1]
#     # read in 4 seconds of data
#     #nsamp = int(4.0/header['tsamp'])
#     nsamp = header['nsamples']
...
#     #dm_err = ibox / 1.0 * 10 # higher dm resolution
#     dm_err = ibox / 1.0 * 25.
#     #dm_err = 250.0
...
#     # higher resolution DM-time data, downsample = 1 
# #     datadm, dms = dm_transform(data, dm_max=dm+dm_err,
# #                                dm_min=dm-dm_err, dm0=dm, ndm=ndm, 
# #                                freq_ref=None, 
# #                                downsample=heim_raw_tres//pre_rebin)
...
#                                downsample=heim_raw_tres//pre_rebin)
    ...
    return data, tsdm0, datadm0 #datadm, dms,
...
#        for datacube in beam_time_arr_results:
    ...
    try:
        if candname != None:
            ...
            #print(f'no - decided to do it elsewhere')
