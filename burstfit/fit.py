...
from burstfit.utils.plotter import plot_1d_fit, plot_2d_fit, plot_fit_results
from burstfit.utils.functions import model_free_4, model_free, model_free_normalized_4, pulse_fn, sgram_fn_vec, gauss, gauss_norm, power_law
...
#             )
    ...
    def calc_redchisq(self):
        ...
        data_size = (~self.mask).sum() # using Liam's filterbank function
